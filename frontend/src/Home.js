...
const Home = () => {
  ...
  return (
    <Container>
      ...
      <h5>1-Write: users request a random text to contribute, and have 2 hours to write and submit their contribution. Each contribution is automatically separated with a double slash (//).</h5>
